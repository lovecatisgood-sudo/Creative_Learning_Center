...
CREATE UNIQUE INDEX IF NOT EXISTS "creative_member_identity_unique" ON "creative_member_identity_links" USING btree ("issuer", "subject");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "creative_member_link_attempts_member_idx" ON "creative_member_link_attempts" USING btree ("member_account_id", "created_at" DESC);
