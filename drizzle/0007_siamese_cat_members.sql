CREATE TYPE "public"."member_token_type" AS ENUM('purchase_claim', 'email_verify', 'email_signin');--> statement-breakpoint
CREATE TYPE "public"."member_consent_type" AS ENUM('terms', 'privacy', 'marketing');--> statement-breakpoint
CREATE TYPE "public"."member_consent_source" AS ENUM('signup', 'staff', 'email_binding');--> statement-breakpoint
...
EXCEPTION WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "member_access_tokens_member_type_idx" ON "member_access_tokens" ("member_account_id", "type");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "member_access_tokens_expiry_idx" ON "member_access_tokens" ("expires_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "member_consents_member_idx" ON "member_consents" ("member_account_id", "accepted_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "member_accounts_phone_idx" ON "member_accounts" ("phone_normalized");--> statement-breakpoint
