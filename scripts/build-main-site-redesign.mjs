...
const home = layout({
  ...
  <div class="container hero-grid">
    ...
    <div class="hero-art reveal visible" data-delay="1"><div class="gallery-item environment-card" style="width:min(100%,520px);min-height:520px"><img class="environment-photo" src="/main-site/assets/environment-play-area.webp" alt="Children playing inside Siamese Cat Creative Club"><div class="caption"><strong>${text("Playgroup and after-school care in one warm space", "Playgroup และหลังเลิกเรียนในพื้นที่อบอุ่นเดียวกัน")}</strong></div></div></div>
  </div>
</section>
<section class="utility-row"><div class="container pill-row"><span class="info-pill"><span class="dot"></span>${text("Small-group supervision", "ดูแลแบบกลุ่มเล็ก")}</span><span class="info-pill"><span class="dot"></span>${text("Clear current pricing", "ราคาแพ็กเกจปัจจุบันชัดเจน")}</span><span class="info-pill"><span class="dot"></span>${text("Meal care available", "มีบริการดูแลมื้ออาหาร")}</span><span class="info-pill"><span class="dot"></span>${text("Animal visits when available", "พบสัตว์เมื่อพร้อมให้บริการ")}</span></div></section>
${programsIntro()}
<section class="section fawn"><div class="container"><div class="section-head"><span class="eyebrow">${text("Current menu", "เมนูแพ็กเกจปัจจุบัน")}</span><h2>${text("The old membership set has been replaced with these packages", "เปลี่ยนจากแพ็กเกจสมาชิกเดิมมาเป็นชุดราคานี้")}</h2><p class="kicker">${text("Both programs start with simple 1-hour and 2-hour options. Longer care and passes depend on whether the family needs playgroup or after-school support.", "ทั้งสองโปรแกรมเริ่มจากตัวเลือก 1 ชั่วโมงและ 2 ชั่วโมง ส่วนการดูแลที่นานขึ้นและบัตรเหมาขึ้นอยู่กับว่าเป็นเพลย์กรุ๊ปหรือการดูแลหลังเลิกเรียน")}</p></div><div class="plan-grid">
${priceCard({ tag: text("Both programs", "ทั้งสองโปรแกรม"), title: text("1-Hour Entry", "เข้าเล่น 1 ชั่วโมง"), price: "199 THB", desc: text("Short playroom visit, waiting time or quick after-school care.", "เหมาะสำหรับมาเล่นสั้น ๆ รอรับ หรือดูแลหลังเลิกเรียนแบบรวดเร็ว"), cta: text("Start with 1 hour", "เริ่ม 1 ชั่วโมง"), href: "/first-visit" })}
${priceCard({ tag: text("Both programs", "ทั้งสองโปรแกรม"), title: text("2-Hour Session", "เซสชัน 2 ชั่วโมง"), price: "300 THB", desc: text("More time to settle, play, draw and join simple activities.", "มีเวลาปรับตัว เล่น วาดรูป และเข้าร่วมกิจกรรมง่าย ๆ มากขึ้น"), cta: text("Start with 2 hours", "เริ่ม 2 ชั่วโมง"), href: "/first-visit", tone: "green" })}
${priceCard({ tag: text("Weekday value", "คุ้มค่าวันธรรมดา"), title: text("4-Hour Half-Day", "ครึ่งวัน 4 ชั่วโมง"), price: "599 THB", desc: text("Available as weekday playgroup half-day or after-school half-day support.", "ใช้ได้ทั้งเพลย์กรุ๊ปครึ่งวันธรรมดา หรือดูแลหลังเลิกเรียน 4 ชั่วโมง"), cta: text("Compare packages", "เทียบแพ็กเกจ"), href: "/memberships", featured: true, tone: "coral" })}
${priceCard({ tag: text("Playgroup", "เพลย์กรุ๊ป"), title: text("Weekday Full-Day", "เต็มวันวันธรรมดา"), price: "999 THB", desc: text("Up to 8 hours of playgroup care with meal-care value included in the parent value story.", "ดูแลเพลย์กรุ๊ปสูงสุด 8 ชั่วโมง พร้อมมูลค่ามื้ออาหารในความคุ้มค่าของแพ็กเกจ"), cta: text("See Playgroup", "ดูเพลย์กรุ๊ป"), href: "/playgroup", tone: "blue" })}
${priceCard({ tag: text("Weekend playgroup", "เพลย์กรุ๊ปวันหยุด"), title: text("Saturday or Sunday Full-Day", "เต็มวันเสาร์หรืออาทิตย์"), price: "1,500 THB", desc: text("Weekend full-day support with structured play, creative time and meal care.", "การดูแลเต็มวันช่วงวันหยุด พร้อมการเล่น กิจกรรมสร้างสรรค์ และมื้ออาหาร"), cta: text("See weekend care", "ดูแพ็กเกจวันหยุด"), href: "/playgroup#weekend", tone: "green" })}
${priceCard({ tag: text("Meal support", "มื้ออาหาร"), title: text("Meal Care", "Meal Care"), price: "250 / 299 THB", desc: text("250 THB playgroup meal-care value; 299 THB after-school meal add-on.", "มูลค่ามื้ออาหารเพลย์กรุ๊ป 250 บาท และ Meal Care หลังเลิกเรียน 299 บาท"), cta: text("See meal care", "ดูมื้ออาหาร"), href: "/dinner", tone: "blue" })}
</div></div></section>
<section class="section"><div class="container"><div class="section-head center"><span class="eyebrow">${text("Daily rhythm", "จังหวะประจำวัน")}</span><h2>${text("A clear routine without making the site feel like a price list", "กิจวัตรชัดเจน ไม่ใช่แค่หน้าราคา")}</h2></div><div class="paw-timeline reveal"><div class="paw-step"><div class="paw-node">1</div><div><h3>${text("Arrive & settle", "มาถึงและปรับตัว")}</h3><p class="small">${text("Wash hands, put bags away and get comfortable.", "ล้างมือ วางกระเป๋า และค่อย ๆ ปรับตัว")}</p></div></div><div class="paw-step"><div class="paw-node">2</div><div><h3>${text("Play or focus", "เล่นหรือโฟกัส")}</h3><p class="small">${text("Playgroup children explore. After-school children may do homework or quiet focus.", "เด็กเพลย์กรุ๊ปได้สำรวจ เด็กหลังเลิกเรียนอาจทำการบ้านหรือกิจกรรมเงียบ")}</p></div></div><div class="paw-step"><div class="paw-node">3</div><div><h3>${text("Create & explore", "สร้างสรรค์และสำรวจ")}</h3><p class="small">${text("Drawing, Lego, clay, reading, soft play, outdoor play or animal visits when available.", "วาดรูป เลโก้ ดินปั้น อ่านหนังสือ เล่นนุ่ม ๆ เล่นกลางแจ้ง หรือพบสัตว์เมื่อพร้อม")}</p></div></div><div class="paw-step"><div class="paw-node">4</div><div><h3>${text("Meal & pickup", "มื้ออาหารและรับกลับ")}</h3><p class="small">${text("Meal care can be arranged for longer sessions or after-school evening pickup.", "สามารถจัด Meal Care สำหรับเซสชันยาวหรือรอรับช่วงเย็น")}</p></div></div></div></div></section>
...
const memberships = layout({
  ...
  description: "Current packages for Little Explorer Playgroup and After School Explorer Program.",
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Current packages only", "แพ็กเกจปัจจุบันเท่านั้น")}</span><h1>${text("Packages for Playgroup and Creative Club", "แพ็กเกจสำหรับ Playgroup และ Creative Club")}</h1><p class="lead">${text("This page replaces the older membership set. Families now choose from Little Explorer Playgroup sessions, After School Explorer sessions, meal care and regular passes.", "หน้านี้แทนชุดสมาชิกเดิม ครอบครัวเลือกจากเซสชัน Little Explorer Playgroup, After School Explorer, Meal Care และบัตรสำหรับมาเป็นประจำ")}</p><div class="hero-actions"><a class="btn btn-primary" href="/signup">${text("Register Interest", "ลงทะเบียนความสนใจ")}</a><a class="btn btn-secondary" href="/playgroup">${text("Playgroup Details", "รายละเอียด Playgroup")}</a><a class="btn btn-secondary" href="/creative">${text("Creative Club Details", "รายละเอียด Creative Club")}</a></div></div><div class="hero-art reveal visible"><div class="card soft-mint"><span class="eyebrow">${text("Quick choice", "เลือกเร็ว")}</span><h3>${text("Need daytime or weekend care?", "ต้องการช่วงกลางวันหรือวันหยุด?")}</h3><p>${text("Start with Little Explorer Playgroup.", "เริ่มที่ Little Explorer Playgroup")}</p><h3>${text("Need after-school pickup support?", "ต้องการดูแลหลังเลิกเรียนและรอรับ?")}</h3><p>${text("Start with After School Explorer Program.", "เริ่มที่ After School Explorer Program")}</p></div></div></div></section>
...
const dinner = layout({
  ...
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Meal care", "Meal Care")}</span><h1>${text("Meal Care without confusing dinner memberships", "Meal Care ที่ชัดเจน ไม่ใช่สมาชิกอาหารเย็นแบบเดิม")}</h1><p class="lead">${text("The old Basic/Premium dinner membership has been replaced. Meal support is now shown as either a 250 THB playgroup meal-care value or a 299 THB after-school add-on.", "ยกเลิกแพ็กเกจอาหารเย็น Basic/Premium เดิม และแสดง Meal Care เป็นมูลค่า 250 บาทสำหรับ Playgroup หรือ Add-On 299 บาทสำหรับหลังเลิกเรียน")}</p><div class="hero-actions"><a class="btn btn-primary" href="/signup">${text("Request Meal Care", "ขอ Meal Care")}</a><a class="btn btn-secondary" href="/memberships">${text("View Packages", "ดูแพ็กเกจ")}</a></div></div><div class="hero-art reveal visible"><div class="gallery-item environment-card" style="width:min(100%,520px);min-height:520px"><img class="environment-photo" src="/main-site/assets/environment-cat-cafe-dinner.webp" alt="Cafe dinner"><div class="caption"><strong>${text("Cafe meal support", "ดูแลมื้ออาหารจากคาเฟ่")}</strong></div></div></div></div></section>
...
const inside = layout({
  ...
  description: "Spaces, safety routines and activities for Playgroup and Creative Club children.",
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Inside the Club", "ภายในคลับ")}</span><h1>${text("A real space for play, focus, meals and pickup", "พื้นที่จริงสำหรับเล่น โฟกัส มื้ออาหาร และรอรับกลับ")}</h1><p class="lead">${text("Both programs use the same warm environment: indoor play, creative tables, quiet focus, reading, meal support and supervised animal visits when available.", "ทั้งสองโปรแกรมใช้พื้นที่อบอุ่นเดียวกัน: เล่นในร่ม โต๊ะสร้างสรรค์ มุมโฟกัส อ่านหนังสือ ดูแลมื้ออาหาร และพบสัตว์แบบมีทีมงานดูแลเมื่อพร้อม")}</p><div class="hero-actions"><a class="btn btn-primary" href="/playgroup">${text("Playgroup", "Playgroup")}</a><a class="btn btn-secondary" href="/creative">${text("Creative Club", "Creative Club")}</a></div></div><div class="hero-art reveal visible"><div class="gallery-item environment-card" style="width:min(100%,520px);min-height:520px"><img class="environment-photo" src="/main-site/assets/environment-creative-room.webp" alt="Creative room"><div class="caption"><strong>${text("Creative and calm activity space", "พื้นที่กิจกรรมสร้างสรรค์และสงบ")}</strong></div></div></div></div></section>
...
const firstVisit = layout({
  ...
  description: "Choose the best first session for Playgroup or Creative Club.",
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Start here", "เริ่มที่นี่")}</span><h1>${text("Choose a real first session", "เลือกเซสชันแรกจากแพ็กเกจจริง")}</h1><p class="lead">${text("Families can start with the current 1-hour, 2-hour or 4-hour options, then choose Playgroup or Creative Club after registration.", "ครอบครัวสามารถเริ่มจากตัวเลือกปัจจุบัน 1 ชั่วโมง 2 ชั่วโมง หรือ 4 ชั่วโมง แล้วเลือก Playgroup หรือ Creative Club หลังลงทะเบียน")}</p><div class="hero-actions"><a class="btn btn-primary" href="/signup">${text("Register first", "ลงทะเบียนก่อน")}</a><a class="btn btn-secondary" href="/memberships">${text("Compare packages", "เทียบแพ็กเกจ")}</a></div></div><div class="hero-art reveal visible"><div class="card soft-mint"><h3>${text("Best first choices", "ตัวเลือกเริ่มต้นที่เหมาะ")}</h3>${detailsList([text("1 hour / 199 THB for a short visit.", "1 ชั่วโมง / 199 บาท สำหรับมาเล่นสั้น ๆ"), text("2 hours / 300 THB for more time to settle.", "2 ชั่วโมง / 300 บาท สำหรับมีเวลาปรับตัวมากขึ้น"), text("4 hours / 599 THB for weekday half-day value.", "4 ชั่วโมง / 599 บาท สำหรับความคุ้มค่าครึ่งวันธรรมดา")])}</div></div></div></section>`
});
...
const faq = layout({
  ...
  <div class="faq-category"><h2>${text("Programs", "โปรแกรม")}</h2><div class="faq-list">
    ...
    <details class="faq-item"><summary>${text("Is this private nanny care?", "เป็นบริการพี่เลี้ยงส่วนตัวหรือไม่?")}</summary><div class="faq-answer"><p>${text("No. Both programs are supervised small-group programs, not one-on-one nanny service.", "ไม่ใช่ ทั้งสองโปรแกรมเป็นการดูแลแบบกลุ่มเล็กที่มีทีมงานดูแล ไม่ใช่บริการพี่เลี้ยงตัวต่อตัว")}</p></div></details>
  ...
  <div class="faq-category"><h2>${text("Prices and meal care", "ราคาและ Meal Care")}</h2><div class="faq-list">
    <details class="faq-item" open><summary>${text("What are the current starting prices?", "ราคาเริ่มต้นปัจจุบันคือเท่าไร?")}</summary><div class="faq-answer"><p>${text("Both programs start at 199 THB for 1 hour and 300 THB for 2 hours. Weekday 4-hour half-day care is 599 THB.", "ทั้งสองโปรแกรมเริ่มที่ 199 บาทสำหรับ 1 ชั่วโมง และ 300 บาทสำหรับ 2 ชั่วโมง ส่วนครึ่งวันธรรมดา 4 ชั่วโมงราคา 599 บาท")}</p></div></details>
    <details class="faq-item"><summary>${text("What happened to the old membership packages?", "แพ็กเกจสมาชิกเดิมหายไปไหน?")}</summary><div class="faq-answer"><p>${text("They have been replaced by the current Playgroup and After School Explorer package menus shown on the Packages page.", "ถูกแทนด้วยเมนูแพ็กเกจ Playgroup และ After School Explorer ชุดปัจจุบันตามที่แสดงในหน้าแพ็กเกจ")}</p></div></details>
...
const notFound = layout({
  ...
  body: `<section class="success-wrap"><div class="narrow"><span class="eyebrow">404</span><h1 style="font-size:clamp(48px,8vw,86px)">${text("This page moved", "หน้านี้ถูกย้าย")}</h1><p class="kicker" style="margin-inline:auto">${text("The current programs are Playgroup and Creative Club. Start from the packages page.", "โปรแกรมปัจจุบันคือ Playgroup และ Creative Club เริ่มจากหน้าแพ็กเกจได้")}</p><div class="hero-actions" style="justify-content:center"><a class="btn btn-primary" href="/memberships">${text("View Packages", "ดูแพ็กเกจ")}</a><a class="btn btn-secondary" href="/">${text("Return Home", "กลับหน้าหลัก")}</a></div></div></section>`
});
