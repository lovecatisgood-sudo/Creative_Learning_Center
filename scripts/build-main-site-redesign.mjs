  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-visit">
        ...
        <address class="footer-links"><span>${text("46/27 Bang Na-Trat Frontage Road, Bang Kaeo", "46/27 ถนนคู่ขนานบางนา-ตราด บางแก้ว")}</span><span>${text("Weekdays 3-8 PM for after-school support", "หลังเลิกเรียนวันธรรมดา 15:00-20:00")}</span><span>${text("Playgroup times by confirmed booking", "เวลาเพลย์กรุ๊ปตามการจองที่ยืนยันแล้ว")}</span><a href="${MAP_URL}" target="_blank" rel="noreferrer">${text("Get directions", "ดูเส้นทาง")}</a><a href="mailto:Cafe@siamesecat.cafe">Cafe@siamesecat.cafe</a><a href="tel:+66952413028" data-phone>${text("+66 95 241 3028", "+66 95 241 3028")}</a></address>
      </div>
    </div>
