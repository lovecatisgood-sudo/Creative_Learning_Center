...
const ASSET_VERSION = "20260717-thai-default";
...
function header(active, canonicalPath) {
  ...
  <div class="container header-inner">
    ...
    <nav class="main-nav" aria-label="${text("Primary navigation", "เมนูหลัก")}">
      ...
      <a data-nav="book" class="btn btn-primary" href="/signup">${text("Parent Signup", "ลงทะเบียนผู้ปกครอง")}</a>
    </nav>
    <div class="header-actions">
      <a class="lang-toggle" data-language-switch href="language-switch${switchHref}" hreflang="${currentLanguage === "th" ? "en" : "th"}" aria-label="${text("Switch to Thai", "เปลี่ยนเป็นภาษาอังกฤษ")}">${currentLanguage === "th" ? "English" : "ไทย"}</a>
...
function footer() {
  ...
  <div class="container">
    <div class="footer-grid">
      <div>
        <div class="brand" style="color:#fff8ed;margin-bottom:18px"><span class="brand-mark"><img class="brand-logo-img" src="/main-site/assets/logo-circle.png" alt="${text("Siamese Cat Creative Club circle logo", "โลโก้ Siamese Cat Creative Club")}"></span><span class="brand-text"><strong>Siamese Cat Creative Club</strong><span style="color:rgba(255,248,237,.7)">${text("Near Mega Bangna", "ใกล้เมกาบางนา")}</span></span></div>
...
<div class="mobile-cta"><a class="btn btn-primary" href="/signup">${text("Parent Signup", "ลงทะเบียนผู้ปกครอง")}</a><a class="btn btn-line" href="tel:+66804803802">${text("Call", "โทร")}</a></div>
<div id="site-toast" class="toast" role="status" aria-live="polite"></div>`;
}

function layout({ page, titleEn, titleTh, description, descriptionTh, body, active = page, extraHead = "" }) {
...
const home = layout({
  ...
  <div class="container hero-grid">
    <div class="hero-copy reveal visible">
      ...
      <div class="hero-actions"><a class="btn btn-primary" href="/memberships">${text("View Packages", "ดูแพ็กเกจ")}</a><a class="btn btn-secondary" href="/playgroup">${text("Little Explorer Playgroup", "Little Explorer Playgroup")}</a><a class="btn btn-secondary" href="/creative">${text("Creative Club", "ครีเอทีฟคลับ")}</a></div>
    ...
    <div class="hero-art reveal visible" data-delay="1"><div class="gallery-item environment-card" style="width:min(100%,520px);min-height:520px"><img class="environment-photo" src="/main-site/assets/environment-play-area.webp" alt="${text("Children playing inside Siamese Cat Creative Club", "เด็กกำลังเล่นภายใน Siamese Cat Creative Club")}"><div class="caption"><strong>${text("Little Explorer Playgroup in the kids' play area", "Little Explorer Playgroup ในโซนเด็ก")}</strong></div></div></div>
  </div>
</section>
...
<section id="passes" class="section"><div class="container"><div class="section-head"><span class="eyebrow">${text("For regular families", "สำหรับครอบครัวที่มาเป็นประจำ")}</span><h2>${text("Playgroup passes", "บัตรเหมารอบเพลย์กรุ๊ป")}</h2><p class="kicker">${text("Passes are recommended for families who want better value and easier planning.", "เหมาะสำหรับครอบครัวที่ต้องการความคุ้มค่าและวางแผนง่ายขึ้น")}</p></div><div class="plan-grid">${priceCard({ tag: text("Weekday", "วันธรรมดา"), title: text("20-Session Weekday Full-Day Pass", "บัตรเต็มวันธรรมดา 20 ครั้ง"), price: "18,000 THB", desc: text("Each full-day session includes supervised playgroup care and meal-care value. Effective price: 900 THB; save 1,980 THB versus 20 separate weekday full days.", "แต่ละครั้งรวมเพลย์กรุ๊ปเต็มวันแบบมีทีมงานดูแลและมูลค่า Meal Care เฉลี่ย 900 บาท ประหยัด 1,980 บาทเมื่อเทียบกับการซื้อแยก 20 ครั้ง"), href: "/signup?plan=playgroup-weekday-pass", cta: text("Ask about this pass", "สอบถามบัตรนี้"), featured: true, tone: "coral" })}${priceCard({ tag: text("Saturday", "วันเสาร์"), title: text("8-Session Saturday Full-Day Pass", "บัตรเต็มวันเสาร์ 8 ครั้ง"), price: "9,200 THB", desc: text("Each Saturday includes supervised full-day care and meal-care value. Effective price: 1,150 THB; save 2,800 THB versus 8 separate Saturdays.", "แต่ละวันเสาร์รวมการดูแลเต็มวันและมูลค่า Meal Care เฉลี่ย 1,150 บาท ประหยัด 2,800 บาทเมื่อเทียบกับการซื้อแยก 8 ครั้ง"), href: "/signup?plan=saturday-pass", cta: text("Ask about Saturday pass", "สอบถามบัตรวันเสาร์"), tone: "green" })}${priceCard({ tag: text("Sunday", "วันอาทิตย์"), title: text("8-Session Sunday Full-Day Pass", "บัตรเต็มวันอาทิตย์ 8 ครั้ง"), price: "9,200 THB", desc: text("Each Sunday includes supervised full-day care and meal-care value. Effective price: 1,150 THB; save 2,800 THB versus 8 separate Sundays.", "แต่ละวันอาทิตย์รวมการดูแลเต็มวันและมูลค่า Meal Care เฉลี่ย 1,150 บาท ประหยัด 2,800 บาทเมื่อเทียบกับการซื้อแยก 8 ครั้ง"), href: "/signup?plan=sunday-pass", cta: text("Ask about Sunday pass", "สอบถามบัตรวันอาทิตย์"), tone: "green" })}</div></div></section>
...
const memberships = layout({
  ...
  descriptionTh: "แพ็กเกจและบัตรเหมารอบสำหรับ Little Explorer Playgroup และโปรแกรม After School Explorer",
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Packages & passes", "แพ็กเกจและบัตรเหมารอบ")}</span><h1>${text("Playgroup Packages and After School Explorer Packages", "แพ็กเกจเพลย์กรุ๊ปและแพ็กเกจ After School Explorer")}</h1><p class="lead">${text("Review Playgroup options for daytime and weekend care, then After School Explorer options for after-school routines and pickup support.", "ดูตัวเลือกเพลย์กรุ๊ปสำหรับกลางวันและวันหยุด จากนั้นดู After School Explorer สำหรับกิจวัตรหลังเลิกเรียนและรอรับกลับ")}</p><div class="hero-actions"><a class="btn btn-primary" href="/signup">${text("Register Interest", "ลงทะเบียนความสนใจ")}</a><a class="btn btn-secondary" href="/playgroup">${text("Playgroup Details", "รายละเอียดเพลย์กรุ๊ป")}</a><a class="btn btn-secondary" href="/creative">${text("After-School Details", "รายละเอียดหลังเลิกเรียน")}</a></div></div><div class="hero-art reveal visible"><div class="card soft-mint"><span class="eyebrow">${text("Quick choice", "เลือกเร็ว")}</span><h3>${text("Need daytime or weekend care?", "ต้องการช่วงกลางวันหรือวันหยุด?")}</h3><p>${text("Use the Little Explorer Playgroup section.", "ดูส่วน Little Explorer Playgroup")}</p><h3>${text("Need after-school pickup support?", "ต้องการดูแลหลังเลิกเรียนและรอรับ?")}</h3><p>${text("Use the After School Explorer section.", "ดูส่วน After School Explorer")}</p></div></div></div></section>
...
const dinner = layout({
  ...
  titleTh: "ดูแลมื้ออาหารและอาหารเย็น | Siamese Cat Creative Club",
  ...
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Meal care", "ดูแลมื้ออาหาร")}</span><h1>${text("Meal Care & Dinner Support", "ดูแลมื้ออาหารและอาหารเย็น")}</h1><p class="lead">${text("Children staying for longer sessions can enjoy a child-friendly meal and drink with staff support during mealtime.", "เด็กที่อยู่เซสชันนานขึ้นสามารถทานอาหารเด็กและเครื่องดื่ม พร้อมทีมงานช่วยดูแลระหว่างมื้ออาหาร")}</p><div class="hero-actions"><a class="btn btn-primary" href="/signup">${text("Request Meal Care", "ขอเพิ่มบริการมื้ออาหาร")}</a><a class="btn btn-secondary" href="/memberships">${text("View Packages", "ดูแพ็กเกจ")}</a></div></div><div class="hero-art reveal visible"><div class="gallery-item environment-card" style="width:min(100%,520px);min-height:520px"><img class="environment-photo" src="/main-site/assets/environment-cat-cafe-dinner.webp" alt="${text("Cafe dinner", "มื้ออาหารจากคาเฟ่")}"><div class="caption"><strong>${text("Cafe meal support", "ดูแลมื้ออาหารจากคาเฟ่")}</strong></div></div></div></div></section>
...
<section class="section"><div class="container"><div class="section-head"><span class="eyebrow">${text("The environment", "บรรยากาศ")}</span><h2>${text("Designed for flexible care, not a fixed classroom", "ออกแบบเพื่อการดูแลแบบยืดหยุ่น ไม่ใช่ห้องเรียนตายตัว")}</h2></div><div class="gallery-grid environment-gallery"><article class="gallery-item large environment-card environment-shop"><img class="environment-photo" src="/main-site/assets/environment-shop-front.webp" alt="${text("Shop front", "ด้านหน้าร้าน")}"><div class="caption"><strong>${text("Near Mega Bangna", "ใกล้เมกาบางนา")}</strong></div></article><article class="gallery-item environment-card environment-creative"><img class="environment-photo" src="/main-site/assets/environment-creative-room.webp" alt="${text("Creative room", "ห้องสร้างสรรค์")}"><div class="caption"><strong>${text("Creative room", "ห้องสร้างสรรค์")}</strong></div></article><article class="gallery-item environment-card environment-play"><img class="environment-photo" src="/main-site/assets/environment-play-area.webp" alt="${text("Play area", "โซนเล่น")}"><div class="caption"><strong>${text("Play area", "โซนเล่น")}</strong></div></article><article class="gallery-item environment-card environment-entrance"><img class="environment-photo" src="/main-site/assets/environment-entrance-pickup.webp" alt="${text("Entrance and pickup", "ทางเข้าและจุดรับกลับ")}"><div class="caption"><strong>${text("Pickup process", "ขั้นตอนรับกลับ")}</strong></div></article><article class="gallery-item environment-card environment-cafe"><img class="environment-photo" src="/main-site/assets/environment-cat-cafe-dinner.webp" alt="${text("Cafe dinner", "มื้ออาหารจากคาเฟ่")}"><div class="caption"><strong>${text("Meal care", "ดูแลมื้ออาหาร")}</strong></div></article></div></div></section>`
});
...
console.log("Wrote 20 localized main-site pages.");
