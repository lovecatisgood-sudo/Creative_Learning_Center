...
const nav = [
  ...
  { key: "membership", href: "/membership", en: "Membership", th: "สมาชิก" },
...
function header(active, canonicalPath) {
  ...
  <div class="container header-inner">
    ...
    <nav class="main-nav" aria-label="${text("Primary navigation", "เมนูหลัก")}">
      ...
      <a data-nav="contact" class="btn btn-primary" href="tel:+66804803802">${text("Contact Us", "ติดต่อเรา")}</a>
    </nav>
...
<div class="mobile-cta"><a class="btn btn-primary" href="tel:+66804803802">${text("Contact Us", "ติดต่อเรา")}</a></div>
...
function sessionMenuCards(program) {
  ...
  const actionHref = playgroup ? null : "tel:+66804803802";
...
const littleExplorerProgram = layout({
  ...
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Play • Learn • Create • Explore", "เล่น • เรียนรู้ • สร้างสรรค์ • สำรวจ")}</span><h1>${text("Little Explorer Program", "โปรแกรม Little Explorer")}</h1><p class="lead">${text("Flexible Little Explorer sessions for short playtime, half-day care, full-day weekday care and weekend care. Children can play, create, read and explore with small-group supervision.", "เซสชัน Little Explorer แบบยืดหยุ่น ทั้งมาเล่นระยะสั้น ครึ่งวัน เต็มวันธรรมดา และวันหยุด เด็กได้เล่น สร้างสรรค์ อ่านหนังสือ และสำรวจโดยมีทีมงานดูแลแบบกลุ่มเล็ก")}</p><div class="hero-actions"><a class="btn btn-primary" href="tel:+66804803802">${text("Contact Us", "ติดต่อเรา")}</a><a class="btn btn-secondary" href="/playgroup">${text("Playgroup Details", "รายละเอียดเพลย์กรุ๊ป")}</a></div></div><div class="hero-art reveal visible"><div class="gallery-item environment-card" style="width:min(100%,520px);min-height:520px"><img class="environment-photo" src="/main-site/assets/environment-play-area.webp" alt="${text("Children's play area", "โซนเล่นสำหรับเด็ก")}"><div class="caption"><strong>${text("Little Explorer sessions for every schedule", "เซสชัน Little Explorer สำหรับหลายรูปแบบตารางเวลา")}</strong></div></div></div></div></section>
...
const dinner = layout({
  ...
  body: `<section class="hero" style="min-height:560px"><div class="container hero-grid"><div class="hero-copy reveal visible"><span class="eyebrow">${text("Meal Plans", "แผนมื้ออาหาร")}</span><h1>${text("Meal Plans", "แผนมื้ออาหาร")}</h1><p class="lead">${text("Children staying for longer sessions can enjoy a child-friendly meal and drink with staff support during mealtime.", "เด็กที่อยู่เซสชันนานขึ้นสามารถทานอาหารเด็กและเครื่องดื่ม พร้อมทีมงานช่วยดูแลระหว่างมื้ออาหาร")}</p><div class="hero-actions"><a class="btn btn-primary" href="/signup">${text("Request Meal Care", "ขอเพิ่มบริการมื้ออาหาร")}</a><a class="btn btn-secondary" href="/little-explorer-program">${text("Little Explorer Program", "โปรแกรม Little Explorer")}</a></div></div><div class="hero-art reveal visible"><div class="gallery-item environment-card" style="width:min(100%,520px);min-height:520px"><img class="environment-photo" src="/main-site/assets/environment-cat-cafe-dinner.webp" alt="${text("Cafe dinner", "มื้ออาหารจากคาเฟ่")}"><div class="caption"><strong>${text("Cafe meal support", "ดูแลมื้ออาหารจากคาเฟ่")}</strong></div></div></div></div></section>
...
console.log("Wrote 22 localized main-site pages.");
