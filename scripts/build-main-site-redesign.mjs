...
<section class="section fawn"><div class="container booking-layout"><aside class="contact-panel"><div class="card contact-method-card"><span class="eyebrow">${text("Direct contact", "ช่องทางติดต่อโดยตรง")}</span><h2>${text("Reach our team", "ติดต่อทีมงาน")}</h2><div class="contact-method-list"><a href="https://wa.me/66952413028" target="_blank" rel="noopener"><strong>WhatsApp</strong><span>+66 95 241 3028</span></a><a href="mailto:Cafe@siamesecat.cafe"><strong>${text("Email", "อีเมล")}</strong><span>Cafe@siamesecat.cafe</span></a><a href="tel:+66952413028"><strong>${text("Telephone", "โทรศัพท์")}</strong><span>+66 95 241 3028</span></a><a href="${CAFE_URL}"><strong>Siamese Cat Cafe</strong><span>siamesecat.cafe</span></a></div></div></aside>
...
<section class="coding-section coding-games"><div class="container"><div class="coding-section__intro"><h2>${text("Two games show the path", "สองเกมที่ทำให้เส้นทางการเรียนมองเห็นได้")}</h2><p>${text("These studio-built games are playable examples of how rules, state, feedback, art and testing become one working product.", "เกมที่สตูดิโอสร้างขึ้นสองเกมนี้เป็นตัวอย่างที่เล่นได้จริง ว่ากติกา สถานะ การตอบสนอง งานภาพ และการทดสอบรวมกันเป็นผลงานหนึ่งชิ้นอย่างไร")}</p></div><div class="coding-game-grid"><article class="coding-game coding-game--maze"><img src="/game/learn_python/assets/world-1-driving-school-concept-v3.webp" width="1024" height="1024" alt="${text("Colourful driving-school world from Car Maze", "ฉากสนามฝึกขับรถสีสันสดใสจากเกม Car Maze")}" loading="lazy" decoding="async"><div><h3>Car Maze: Learn Python</h3><p>${text("A 58-stage coding game built around sequences, loops, conditions and debugging. Children can play it now and recognise the ideas they will learn to build with.", "เกมเขียนโค้ด 58 ด่านที่ใช้ลำดับ ลูป เงื่อนไข และการแก้บั๊ก เด็กเล่นได้ทันทีและเห็นแนวคิดที่จะได้เรียนรู้เพื่อนำไปสร้างผลงาน")}</p><a class="coding-text-link" href="/game/learn_python/en/">${text("Play Car Maze", "เล่น Car Maze ภาษาอังกฤษ")}</a>${currentLanguage === "th" ? '<a class="coding-text-link" href="/game/learn_python/th/">เล่น Car Maze ภาษาไทย</a>' : ""}</div></article><article class="coding-game coding-game--catdog"><div class="coding-game__logo"><img src="/game/cat-vs-dog/assets/img/logo.png" width="640" height="361" alt="Siamese Cat vs Dog 1986" loading="lazy" decoding="async"></div><div><h3>Siamese Cat vs Dog 1986</h3><p>${text("A complete browser game with characters, scoring, levels and player feedback. It shows why architecture and planning matter once an idea grows.", "เกมบนเบราว์เซอร์ที่มีตัวละคร คะแนน ด่าน และการตอบสนองต่อผู้เล่น แสดงให้เห็นว่าการออกแบบสถาปัตยกรรมและการวางแผนสำคัญเพียงใดเมื่อไอเดียเริ่มใหญ่ขึ้น")}</p><a class="coding-text-link" href="/game/cat-vs-dog/en/">${text("Play Cat vs Dog", "เล่น Cat vs Dog ภาษาอังกฤษ")}</a>${currentLanguage === "th" ? '<a class="coding-text-link" href="/game/cat-vs-dog/th/">เล่น Cat vs Dog ภาษาไทย</a>' : ""}</div></article></div></div></section>
...
console.log("Wrote 30 localized main-site pages.");
