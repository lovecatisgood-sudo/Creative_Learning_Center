...
const ASSET_VERSION = "20260717-production-audit";
...
function layout({ page, titleEn, titleTh, description, body, active = page, extraHead = "" }) {
  ...
  const canonicalUrl = `https://creative.siamesecat.cafe${canonicalPath}`;
  return `<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
function sessionMenuCards(program) {
  ...
  const cards = [
    ...
    priceCard({ tag: text("Weekday value", "คุ้มค่าวันธรรมดา"), title: playgroup ? text("Weekday Half-Day Playgroup", "เพลย์กรุ๊ปครึ่งวันธรรมดา") : text("Weekday After School Half-Day", "หลังเลิกเรียนครึ่งวันธรรมดา"), price: "599 THB", desc: playgroup ? text("Four hours of supervised playgroup care. Total parent value is up to 1,046 THB including 250 THB meal-care value, saving up to 447 THB.", "เพลย์กรุ๊ปแบบมีทีมงานดูแล 4 ชั่วโมง มูลค่ารวมสูงสุด 1,046 บาท รวมมูลค่า Meal Care 250 บาท ประหยัดสูงสุด 447 บาท") : text("Four hours of after-school care with play, creative activity, homework support and quiet focus. Saves 197 THB versus four separate 1-hour entries, before meal care.", "ดูแลหลังเลิกเรียน 4 ชั่วโมง พร้อมเล่น กิจกรรมสร้างสรรค์ ดูแลการบ้าน และมุมสงบ ประหยัด 197 บาทเมื่อเทียบกับ 1 ชั่วโมง 4 ครั้ง ก่อนเพิ่ม Meal Care"), href: playgroup ? "/signup?program=playgroup-half-day" : "/signup?program=creative-half-day", cta: text("Request 4 hours", "ขอจอง 4 ชั่วโมง"), featured: true, tone: "coral" }),
  ];
  if (playgroup) {
    cards.push(
      priceCard({ tag: text("Weekday full day", "เต็มวันวันธรรมดา"), title: text("Weekday Full-Day Playgroup", "เพลย์กรุ๊ปเต็มวันธรรมดา"), price: "999 THB", desc: text("Up to 8 hours of supervised playgroup care. Total parent value is up to 1,842 THB including 250 THB meal-care value, saving up to 843 THB.", "เพลย์กรุ๊ปแบบมีทีมงานดูแลสูงสุด 8 ชั่วโมง มูลค่ารวมสูงสุด 1,842 บาท รวมมูลค่า Meal Care 250 บาท ประหยัดสูงสุด 843 บาท"), href: "/signup?program=playgroup-weekday-full", cta: text("Request weekday full day", "ขอจองเต็มวันธรรมดา"), tone: "blue" }),
      ...
      priceCard({ tag: text("Weekend", "วันหยุด"), title: text("Sunday Full-Day Playgroup", "เพลย์กรุ๊ปเต็มวันอาทิตย์"), price: "1,500 THB", desc: text("A full Sunday of supervised play, creativity, simple learning and meal care.", "วันอาทิตย์เต็มวัน พร้อมการเล่น กิจกรรมสร้างสรรค์ การเรียนรู้ง่าย ๆ และ Meal Care แบบมีทีมงานดูแล"), href: "/signup?program=playgroup-sunday-full", cta: text("Request Sunday", "ขอจองวันอาทิตย์"), tone: "green" })
    );
  } else {
    cards.push(
